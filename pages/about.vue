        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-10 border-b-2 border-white/70 pb-10">
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <p class="text-xl md:text-[20px] font-light leading-8">Athena Plus - это мечта двух студентов создавать сайты мирового уровня. Повышение качества сайтов и уровня разработчиков, является нашим кредо и первостепенной задачей.
