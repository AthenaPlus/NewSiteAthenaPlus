...
const stages = ref([
  ...
  {
    title: 'UI-KIT',
    desc: 'Разработка UI-Kit - графической библиотеки для создания единообразного дизайна элементов интерфейса сайта. Необходим в разработке крупных интернет-ресурсов для сохранения общей концепции.',
    price: 150000,
    rotation: 0
  },
  {
    title: 'Разработка',
    desc: 'После утверждения функционального прототипа, мы переходим к созданию технической части сайта. Разработка как со стороны Frontend, так и клиентской серверной части. Подключение платежного кабинета.',
    price: 495000,
    rotation: 0 
  }
]);
