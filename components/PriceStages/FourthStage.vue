...
const stages = ref([
  ...
  {
    title: 'Figma-прототип',
    desc: 'Создание интерактивного макета приложения в Figma. Тестировка Customer Journey Map и дальнейшая отладка UX/UI-процессов. Обеспечит высокое удобство пользования приложением.',
    price: 225000,
    rotation: 0,
    isOpen: false
  },
