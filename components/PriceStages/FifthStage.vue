...
const stages = ref([
  ...
  {
    title: 'Брендбук',
    desc: 'Адаптируем дизайн сайта под различные устройства - мониторы, планшеты и телефоны, чтобы обеспечить корректное отображение и удобство использования, не потеряв потенциальных клиентов',
    price: 145000,
    rotation: 0 
  }
]);
