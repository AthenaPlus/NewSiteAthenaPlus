        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-wrap items-start mt-[20px] md:mt-[230px]">
                ...
                <div class="xl:w-1/4 lg:w-1/2 md:w-full px-0 md:px-8 py-6 ">
                    ...
                    <p class="text-base">
                        Обговариваем детали заказа. На этом этапе устанавливаются ваши предпочтения и формируется концепция будущего проекта. Совместно формируем техническое задание и бриф.
                    </p>
                </div>
                <div class="xl:w-1/4 lg:w-1/2 md:w-full px-0 md:px-8 py-6 ">
