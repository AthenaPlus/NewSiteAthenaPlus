        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-wrap items-start mt-[20px] md:mt-[230px]">
                ...
                <div class="xl:w-1/4 lg:w-1/2 md:w-full px-0 md:px-8 py-6 ">
                    ...
                    <p class="text-base">
                        Еще раз проверяем проект. Узнаем как сайт будет работать в разных ситуациях. После этого мы проводим первичную оптимизацию и выводим сайт в диджитал-сферу
                    </p>
                </div>
            </div>
