<template>
    ...
    <button @click="toggle" id="menu-button" class="transition ease-in-out duration-700 fixed pl-2.5 md:pl-5 pt-[7px] z-index-10000 animate__animated animate__pulse animate__infinite">
        <!-- Button First -->
        ...
        <div class="px-5 py-0 mx-auto flex flex-wrap flex-row items-center justify-between">
            ...
            <div class="flex flex-initial border_l_1 h-10 md:h-[51px] pl-4">
                ...
                <div class="hidden sm:flex items-center border_l_1 h_51 ml_18 pl-5">
                    ...
                    <a href="https://wa.me/77753938855" target="_blank" class="ml-3 text-gray-100 link-to-svg mr-9">
                    ...
                    <a href="https://www.instagram.com/athena_plus/" target="_blank" class="ml-3 mr-4 text-gray-100 link-to-svg">
...
<script setup>
import IconKube from '~/assets/icons/kube.svg'
